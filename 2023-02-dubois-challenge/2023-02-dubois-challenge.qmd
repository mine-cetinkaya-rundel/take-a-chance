...
### Step 1. Create segmented bar plot
...
### Step 2. Add labels within each bar. 
...
### Step 3. Flip coordinates to make bars horizontal.
...
### Step 4. Use Du Bois color palette and update legend 
...
ggplot(data = income_long, aes(x = class_income, y = percentage, fill = expenditure)) +
  ...
  coord_flip() + 
  scale_x_discrete(limits = rev) + 
  scale_fill_manual(labels = c("RENT.", "FOOD.", "CLOTHES.", "DIRECT TAXES.", 
...
### Step 5. Reposition legend and update axis labels and title
