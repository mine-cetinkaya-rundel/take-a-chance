...
When I think about the statisticians I encountered during my education, the four individuals in @fig-coasters, seen on my personal coaster set, come to mind.
...
#| echo: FALSE
#| label: fig-google
#| fig-cap: In a Google search for famous statisticians, the individuals listed include Tukey, Nightingale, Fisher, Cox, Pearson, Box, Bayes, Deming, and Gosset.
#| out-width: "80%"
#| fig-align: center
...
When individuals don't feel a part of the community, their identity gets mixed up with feelings about their ability.  @fig-xkcd shows an xkcd comic encapsulates what can happen when individuals of the non-dominant demographic group engage with content of the course / curriculum / minor / major.
