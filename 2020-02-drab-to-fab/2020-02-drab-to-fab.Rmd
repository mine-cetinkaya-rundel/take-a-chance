...
```{r skateboard-drab-old, echo=FALSE, fig.cap="Comparison of specifications for electric skateboards."}
#knitr::include_graphics("img/skateboard_compare.jpg")
knitr::include_graphics("img/skateboard_compare_create.png")
```
