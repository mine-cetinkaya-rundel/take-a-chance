...
By making the lines for the other faculty levels gray, we can still see the trends at those levels; however, they do not distract from the primary level of interest - part time faculty. Now the reader can get one clear message from the plot after only a few moments of examination. 
