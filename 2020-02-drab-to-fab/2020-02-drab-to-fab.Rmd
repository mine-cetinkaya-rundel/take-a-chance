...
In this column we walk through present three examples of ``from drab to fab" type class activities, i.e. improving data visualisations. 
...
Electric Skateboard HQ Comparison Chart([www.electricskateboardhq.com/boards-comparison/](https://www.electricskateboardhq.com/boards-comparison/))

The data for used to create this plot may be found [here](https://compare-skateboards.com/#1488732069728-b989687a-f273).

```{r echo=FALSE, fig.cap="Comparison of specifications for electronic skateboards"}
knitr::include_graphics("img/skateboard_compare.jpg")
```

- Primary issue with this visulaization is that they're trying to convey too much information on one graph. 

1. Begin by having the students list of all the variables included in this visualizaton and how they are displayed in the scatterplot.
  - Relationship between the top speed and the range (points on x and y axis)
  - Manufacturer (color of points)
