...
One way to use COVID-19 data in the classroom is by having students think about effective data visualizations. Since the beginning of the pandemic, there have been a variety of data visualizations used by government entities, news media, and the public outlets to help the general public better understand the pandemic (e.g. the "flattening the curve" visualizations). The activity could have four components: 

1. Students consider what makes a visualization effective, especially when presenting data that is rapidly changing and potentially incomplete. The article [*Ten Considerations Before You Create Another Chart About COVID-19*](https://medium.com/nightingale/ten-considerations-before-you-create-another-chart-about-covid-19-27d3bd691be8) can serve as a template for the discussion. 
2. Students critique an existing visualization about the pandemic, discussing what makes it effective and what is confusing or even misleading.
3. Students can create their own visualization taking into account the tips and critiques they discussed. This is an opportunity for students to think about the ethics of responsible data visualizations. It also gives them an opportunity to hone their computing skills as they wrangle and visualize the data using statistical software. Students could design their own visualizations, or could try to replicate effective exisiting visualizations. This replication approach is used in [I Eat Data Science for Breakfast: pandemic 2020 edition](https://learn.themethodsection.com/workshops/ieat/pandemic2020/), where an existing plot is used as the inspiration, and the goal is to replicate it using the skills discussed in that week's lesson. 
